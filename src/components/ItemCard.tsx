...
export default function ItemCard({ data, cart, handleAddCart, handleRemoveCart }: ItemCartProps) {
    ...
    return (
        <div className='flex mb-4 gap-4'>
            ...
            <Image src={'/images/menu/burgers.jpg'} width={128} height={128} alt={description} className='rounded-full' />
            <div className='bg-white rounded-xl p-1 grow flex flex-col items-center justify-around'>
